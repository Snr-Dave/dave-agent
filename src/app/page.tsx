 ...
 export default function Home() {
   const [messages, setMessages] = useState([{ role: "system", content: "You are Uzor, a helpful AI assistant." }]);
                                                                                                                 ...
                                                                                                                 <h1 className="text-3xl font-bold mb-6">🤖 Uzor Chatbot</h1>
                                                                                                                       ...
                                                                                                                       <div className="w-full max-w-2xl space-y-4 bg-gray-800 p-4 rounded-lg overflow-y-auto h-[70vh]">
                                                                                                                               {messages.slice(1).map((msg, i) => (
                                                                                                                                         <div key={i} className={`p-3 rounded ${msg.role === "user" ? "bg-blue-600 text-right" : "bg-gray-700 text-left"}`}>
                                                                                                                                                     <p><strong>{msg.role === "user" ? "You" : "Uzor"}:</strong> {msg.content}</p>
                                                                                                                                                               </div>
                                                                                                                                                                       ))}
                                                                                                                                                                             </div>
